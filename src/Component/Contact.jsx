...
<div className="contact-form">
    <input type="text" placeholder="Company Name" onChange={(e) => setCompany(e.target.value)} /><br/>
    <input type="text" placeholder="Person Name" onChange={(e) => setperson(e.target.value)} /><br/>
    <input type="text" placeholder="Address"  className="contact-address" onChange={(e) => setaddress(e.target.value)}/><br/>
    <input type="text" placeholder="City" onChange={(e) => setCity(e.target.value)} /><br/>
    <input type="text" placeholder="Mobile No." onChange={(e) => setMobileno(e.target.value)} /><br/>
